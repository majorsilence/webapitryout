...
namespace WebApplication1.Filters
{
    ...
    public class BasicAuthenticationFilter : AuthorizationFilterAttribute
    {
        ...
        /// </summary>
        /// <param name="actionContext"></param>
        protected virtual Security.BasicAuthenticationIdentity ParseAuthorizationHeader(HttpActionContext actionContext)
        {
            ...
            return new Security.BasicAuthenticationIdentity(username, password);
        }
